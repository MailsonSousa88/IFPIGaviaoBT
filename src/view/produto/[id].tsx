...
export default function Produto() {
  ...
  if (produtoState.erro || !produtoState.produto) {
    return (
      <View style={styles.erroContainer}>
        <Text style={styles.erroTexto}>
          {produtoState.erro ?? "Item não encontrado."}
        </Text>
      </View>
    );
  }

  const produto = produtoState.produto;
          ...
          <View style={styles.quantidadeLinha}>
            ...
            <View style={styles.seletorContainer}>
              <TouchableOpacity
                ...
                onPress={produtoActions.diminuirQuantidade}
              >
                <Ionicons name="remove" size={20} color="#ffffff" />
              </TouchableOpacity>

              <Text style={styles.numeroQuantidade}>
                {produtoState.quantidade}
              </Text>

              <TouchableOpacity
                style={styles.btnMais}
                onPress={produtoActions.aumentarQuantidade}
              >
